                                ...
                                <form action="" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="penilaian" name="penilaian" value="<?php if($row_peserta["penilaian"] == "") { 
                                                echo "Belum Dinilai";
                                            } else {
                                                echo $row_peserta["penilaian"]; } ?>" placeholder="Penilaian Hasil Bimtek" readonly>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
