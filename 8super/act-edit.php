...
include "conn.php";
$id=$_GET["id"];
$data=mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM activities"));
if (isset($_POST["submit"])) {
    $act_name=$_POST["act_name"];
    $category=$_POST["category"];
    $save=mysqli_query($conn, "UPDATE activities SET 
    act_name='$act_name',
    category='$category'
    WHERE id=$id");
    if ($save) {
        echo "<script type='text/javascript'>
            alert ('Updating Activity Success');
            document.location.href='act.php';
            </script>;";
    }else{
        echo "<script type='text/javascript'>
            alert ('Updating Activity Failed');
            document.location.href='act-edit.php?id=$id';
            </script>;";
    }
}
?>
    ...
    <div class="box">
        ...
        <form action="" method="post">
            <div class="input">
                ...
                <div class="input-item">
                    <input value="<?= $data["act_name"]; ?>" type="text" name="act_name" id="act_name">
                </div>
                <div class="input-item">
                    <label for="category">Category</label>
                </div>
                <div class="input-item">
                    <input value="<?= $data["category"]; ?>" type="text" name="category" id="category">
