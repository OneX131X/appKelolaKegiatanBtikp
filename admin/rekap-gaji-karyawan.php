        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Rekap Gaji Karyawan Bulan  <?php echo $tahun ?></h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="rekap-gaji.php">Gaji Per Tahun</a></li>
                                <li class="breadcrumb-item"><a href="rekap-gaji-bulan.php?tahun=<?php echo $tahun ?>">Gaji Per Bulan</a></li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <button type="button" class="btn btn-primary" onclick="window.location='rekap-gaji-bulan.phptahun=<?php echo $tahun ?>'">Kembali</button>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
