...
if (isset($_POST["submit"])) {
    ...
    if ($edit) {
        ...
        echo "<script type='text/javascript'>
                alert('Data Reservasi GAGAL diubah...!');
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="kegiatan_id" name="kegiatan_id" required>
                                                ...
                                                ?>
                                                <option value="<?php echo $row_kegiatan["id"]; ?>" <?php if ($row_reservasi["kegiatan_id"] == $row_kegiatan["id"]) {
                                                    echo "selected";
                                                } ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control col-2" id="checkin" name="checkin" value="<?php echo $row_reservasi["checkin"]; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="checkout">Tanggal Check Out :</label>
                                            <input type="date" class="form-control col-2" id="checkout" name="checkout" value="<?php echo $row_reservasi["checkout"]; ?>" required>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
