                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="fasilitas-kamar-hapus.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger btn-xs text-light" onClick="javascript: return confirm('Apakah yakin ingin menghapus data ini...?');"><i class="fa fa-trash"></i> Hapus</a>
                                                    </td>
